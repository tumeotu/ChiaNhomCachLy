...
public class TrungTam {
    ...
    public void InputPhong()
    {
        ...
        Scanner scanner;
        String FileName="H:\\NAM 3\\QUY HOACH TUYEN TINH\\Tuan1\\BTNhom\\Code\\src\\Phong.txt";
        try {
    ...
    public void InputNhom()
    {
        ...
        Scanner scanner;
        String FileName="H:\\NAM 3\\QUY HOACH TUYEN TINH\\Tuan1\\BTNhom\\Code\\src\\NhomCachLy.txt";
        try {
            File text = new File(FileName);
            scanner = new Scanner(text);
            int n=0;
